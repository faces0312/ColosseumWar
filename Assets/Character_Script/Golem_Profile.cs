...
public class Golem_Profile : MonoBehaviour
{
    public GM_Ch gm;
    ...
    void Update()
    {
        ...
        {
            level_before.text = "체력 80";
            level_after.text = "100";
        ...
        if (Data.Instance.gameData.golem_lv >= 7)
        {
            characteristic.text = "대지의 기운을 획득하여\n일정 시간마다 땅에\n큰 울림을 줍니다";
        }
        else
        {
        ...
        if (Data.Instance.gameData.golem_lv == 1)
        {
    ...
    {
        if (Data.Instance.gameData.golem_lv == 0 && Data.Instance.gameData.gold >= 1000)
        {
            upgrade_sound_success.Play();
            Data.Instance.gameData.gold -= 1000;
            Data.Instance.gameData.golem_lv++;
            Data.Instance.SaveGameData();
            upgrade.gameObject.SetActive(false);
            return;
        }
        else if (Data.Instance.gameData.golem_lv == 0 && Data.Instance.gameData.gold < 1000)
        {
        ...
        if (Data.Instance.gameData.golem_lv == 1 && Data.Instance.gameData.gold >= 3000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 1 && Data.Instance.gameData.gold < 3000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.golem_lv == 2 && Data.Instance.gameData.gold >= 6000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 2 && Data.Instance.gameData.gold < 6000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.golem_lv == 3 && Data.Instance.gameData.gold >= 10000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 3 && Data.Instance.gameData.gold < 10000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.golem_lv == 4 && Data.Instance.gameData.gold >= 20000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 4 && Data.Instance.gameData.gold < 20000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.golem_lv == 5 && Data.Instance.gameData.gold >= 30000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 5 && Data.Instance.gameData.gold < 30000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.golem_lv == 6 && Data.Instance.gameData.gold >= 50000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.golem_lv == 6 && Data.Instance.gameData.gold < 50000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
