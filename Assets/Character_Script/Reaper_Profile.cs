...
public class Reaper_Profile : MonoBehaviour
{
    public GM_Ch gm;
    ...
    void Update()
    {
        ...
        if (Data.Instance.gameData.reaper_lv >= 7)
        {
            characteristic.text = "마이너스 에너지가 증가하여\n공격 범위가 늘어납니다";
        }
        else
        {
        ...
        if (Data.Instance.gameData.reaper_lv == 1)
        {
    ...
    {
        if (Data.Instance.gameData.reaper_lv == 0 && Data.Instance.gameData.gold >= 1000)
        {
            upgrade_sound_success.Play();
            Data.Instance.gameData.gold -= 1000;
            Data.Instance.gameData.reaper_lv++;
            Data.Instance.SaveGameData();
            upgrade.gameObject.SetActive(false);
            return;
        }
        else if (Data.Instance.gameData.reaper_lv == 0 && Data.Instance.gameData.gold < 1000)
        {
        ...
        if (Data.Instance.gameData.reaper_lv == 1 && Data.Instance.gameData.gold >= 3000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 1 && Data.Instance.gameData.gold < 3000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.reaper_lv == 2 && Data.Instance.gameData.gold >= 6000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 2 && Data.Instance.gameData.gold < 6000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.reaper_lv == 3 && Data.Instance.gameData.gold >= 10000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 3 && Data.Instance.gameData.gold < 10000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.reaper_lv == 4 && Data.Instance.gameData.gold >= 20000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 4 && Data.Instance.gameData.gold < 20000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.reaper_lv == 5 && Data.Instance.gameData.gold >= 30000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 5 && Data.Instance.gameData.gold < 30000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
        ...
        if (Data.Instance.gameData.reaper_lv == 6 && Data.Instance.gameData.gold >= 50000)
        {
            upgrade_sound_success.Play();
        ...
        else if (Data.Instance.gameData.reaper_lv == 6 && Data.Instance.gameData.gold < 50000)
        {
            gm.gold_less.gameObject.SetActive(true);
            upgrade_sound_fail.Play();
            return;
